...
This file is the quick-reference operating contract for indexmap-kotlin. The longer
...
indexmap-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`indexmap`](https://crates.io/crates/indexmap). Upstream Rust is the behavioral oracle while the
